...
namespace Assets.Scripts.Utilities
{
	...
	/// </summary>
	internal class CustomFileReaderBinary : IDisposable
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CustomFileReaderBinary"/> class.
		/// </summary>
		/// <param name="fileName">File name.</param>
		public CustomFileReaderBinary (string fileName)
		{
